...
Namespace MontagneAdministracion
    Public Class ConnectionHelper
        Const ConnectionString As String = "XpoProvider=MSSqlServer;data source=centralmontagne;user id=Gerencia;password=interno.1660;initial catalog=MontagneAdministracion;Persist Security Info=true"
