    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        Else
            If MsgBox("Se procedera a enviar la Orden de compra al proveedor " & GridView3.GetFocusedRowCellValue(colRazonSocial3) & " desde la empresa " & cboEmpresas.Text & ". Desea continuar?", vbYesNo) = vbYes Then
                ...
                Dim firma As string
                If Empresa.Contains("MONTAGNE") then firma = "MONTAGNE OUTDOORS SA" & vbCrLf & "DPTO DE COMPRAS" & vbCrLf & "4773-0091 INT 1650" else firma = ""                'aca se deben agregar el resto de informacion de las otras empresas
